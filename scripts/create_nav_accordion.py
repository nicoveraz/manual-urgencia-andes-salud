...
nav_items = [
    ...
    # L2 sub-grupo D: Guías URG_RCR (50 protocolos PUC/ACHS)
    lnk("Guías URG_RCR",                    "/es/protocolos-clinicos/guias", "mdi-chevron-right"),
    lnk("Respiratorio",                     "/es/protocolos-clinicos/guias#respiratorio"),
    lnk("↳ Sinusitis aguda",                "/es/protocolos-clinicos/guias/sinusitis"),
    lnk("↳ Inf. Respiratoria Alta",         "/es/protocolos-clinicos/guias/infeccion-respiratoria-alta"),
    lnk("↳ Amigdalitis / Flegmón / Epiglotitis", "/es/protocolos-clinicos/guias/amigdalitis-aguda"),
    lnk("↳ Laringitis / Crup",              "/es/protocolos-clinicos/guias/laringitis"),
    lnk("↳ Bronquitis aguda",               "/es/protocolos-clinicos/guias/bronquitis"),
    lnk("↳ Sospecha COVID",                 "/es/protocolos-clinicos/guias/sospecha-covid"),
    lnk("↳ Disnea",                         "/es/protocolos-clinicos/guias/disnea"),
    lnk("↳ EPOC",                           "/es/protocolos-clinicos/guias/epoc"),
    lnk("↳ Asma",                           "/es/protocolos-clinicos/guias/asma"),
    lnk("↳ Neumonía",                       "/es/protocolos-clinicos/guias/neumonia"),
    lnk("Digestivo",                        "/es/protocolos-clinicos/guias#digestivo"),
    lnk("↳ Dolor Abdominal Adulto",         "/es/protocolos-clinicos/guias/dolor-abdominal-adulto"),
    lnk("↳ Síndrome Emético",               "/es/protocolos-clinicos/guias/sindrome-emetico"),
    lnk("↳ Síndrome Diarreico Adulto",      "/es/protocolos-clinicos/guias/sindrome-diarreico-en-el-ad"),
    lnk("↳ Cólico Biliar",                  "/es/protocolos-clinicos/guias/colico-biliar"),
    lnk("↳ Cólico Renal",                   "/es/protocolos-clinicos/guias/colico-renal"),
    lnk("↳ Apendicitis",                    "/es/protocolos-clinicos/guias/apendicitis"),
    lnk("↳ Obstrucción Intestinal",         "/es/protocolos-clinicos/guias/obstruccion-intestinal"),
    lnk("↳ Constipación",                   "/es/protocolos-clinicos/guias/constipacion"),
    lnk("Cardiovascular / Neurológico",     "/es/protocolos-clinicos/guias#cardiovascular"),
    lnk("↳ Hipertensión",                   "/es/protocolos-clinicos/guias/hipertension"),
    lnk("↳ Dolor Torácico",                 "/es/protocolos-clinicos/guias/dolor-toracico"),
    lnk("↳ Palpitaciones",                  "/es/protocolos-clinicos/guias/palpitaciones"),
    lnk("↳ Lipotimia / Síncope",            "/es/protocolos-clinicos/guias/lipotimia-sincope"),
    lnk("↳ Cefalea",                        "/es/protocolos-clinicos/guias/cefalea"),
    lnk("↳ Mareos",                         "/es/protocolos-clinicos/guias/mareos"),
    lnk("↳ Vértigo",                        "/es/protocolos-clinicos/guias/vertigo"),
    lnk("↳ Sospecha ACV",                   "/es/protocolos-clinicos/guias/sospecha-acv"),
    lnk("↳ Compromiso de Conciencia",       "/es/protocolos-clinicos/guias/compromiso-de-conciencia"),
    lnk("Infeccioso / Sistémico",           "/es/protocolos-clinicos/guias#infeccioso"),
    lnk("↳ Síndrome Febril Adulto",         "/es/protocolos-clinicos/guias/sindrome-febril-adulto"),
    lnk("↳ Rash",                           "/es/protocolos-clinicos/guias/rash"),
    lnk("↳ Anafilaxia",                     "/es/protocolos-clinicos/guias/anafilaxia"),
    lnk("↳ Celulitis",                      "/es/protocolos-clinicos/guias/celulitis"),
    lnk("↳ Abscesos",                       "/es/protocolos-clinicos/guias/abscesos-en-otras-partes-de"),
    lnk("↳ Epistaxis",                      "/es/protocolos-clinicos/guias/epistaxis"),
    lnk("↳ Mordedura Insecto / Artrópodo",  "/es/protocolos-clinicos/guias/mordedura-de-insecto-o-artr"),
    lnk("ORL / Oftalmología",               "/es/protocolos-clinicos/guias#orl-oftalmo"),
    lnk("↳ Ojo Rojo sin Trauma",            "/es/protocolos-clinicos/guias/ojo-rojo-sin-trauma"),
    lnk("↳ Ojo Rojo con Trauma",            "/es/protocolos-clinicos/guias/ojo-rojo-con-trauma"),
    lnk("↳ Otalgia",                        "/es/protocolos-clinicos/guias/otalgia"),
    lnk("↳ Hipoacusia",                     "/es/protocolos-clinicos/guias/hipoacusia"),
    lnk("Urológico / Endocrino",            "/es/protocolos-clinicos/guias#urologico"),
    lnk("↳ Disuria Hombre",                 "/es/protocolos-clinicos/guias/disuria-hombre"),
    lnk("↳ Disuria Mujer",                  "/es/protocolos-clinicos/guias/disuria-mujer"),
    lnk("↳ Trastorno Ansioso",              "/es/protocolos-clinicos/guias/trastorno-ansioso"),
    lnk("↳ Hiperglicemia",                  "/es/protocolos-clinicos/guias/hiperglicemia"),
    lnk("Trauma",                           "/es/protocolos-clinicos/guias#trauma"),
    lnk("↳ Trauma Torácico",                "/es/protocolos-clinicos/guias/trauma-toracico"),
    lnk("↳ Trauma Abdominal / Pélvico",     "/es/protocolos-clinicos/guias/trauma-abdominal-o-pelvico"),
    lnk("↳ Golpe en Cráneo",                "/es/protocolos-clinicos/guias/golpe-en-craneo"),
    lnk("Pediátrico",                       "/es/protocolos-clinicos/guias#pediatrico"),
    lnk("↳ SBO Niños",                      "/es/protocolos-clinicos/guias/sbo-ninos"),
    lnk("↳ Dolor Abdominal Niños",          "/es/protocolos-clinicos/guias/dolor-abdominal-ninos"),
    lnk("↳ Síndrome Diarreico Niños",       "/es/protocolos-clinicos/guias/sindrome-diarreico-en-el-ni"),
    lnk("↳ Síndrome Febril Niño",           "/es/protocolos-clinicos/guias/sindrome-febril-del-nino"),
    lnk("Músculo-Esquelético",              "/es/protocolos-clinicos/guias#musculo-esqueletico"),
    lnk("↳ Dolor Lumbar",                   "/es/protocolos-clinicos/guias/dolor-lumbar"),
