...
nav_items = [
    ...
    # ── L1: Protocolos Clínicos — estructurado según Decreto 34 MINSAL ──────────
    hdr("Protocolos Clínicos", "mdi-stethoscope"),

    # L2 sub-grupo A: Adulto — Decreto 34 Título V, Art. 23
    lnk("Adulto — Decreto 34", "/es/protocolos-clinicos/adulto", "mdi-chevron-right"),
    lnk("§1 Respiratorio",          "/es/protocolos-clinicos/adulto/respiratorio"),
    lnk("§2 Circulatorio",          "/es/protocolos-clinicos/adulto/circulatorio"),
    lnk("§3 Neurológico",           "/es/protocolos-clinicos/adulto/neurologico"),
    lnk("§4 Vascular Aguda",        "/es/protocolos-clinicos/adulto/vascular"),
    lnk("§5 Trauma",                "/es/protocolos-clinicos/adulto/trauma"),
    lnk("§6 Quirúrgico",            "/es/protocolos-clinicos/adulto/quirurgico"),
    lnk("§7 Gran Quemado",          "/es/protocolos-clinicos/adulto/gran-quemado"),
    lnk("§8 Intoxicación",          "/es/protocolos-clinicos/adulto/intoxicacion"),
    lnk("§9 Accidentes",            "/es/protocolos-clinicos/adulto/accidentes"),
    lnk("§10 Piel y P. Blandas",    "/es/protocolos-clinicos/adulto/piel-partes-blandas"),
    lnk("§11 Urológico Masc.",      "/es/protocolos-clinicos/adulto/urologico"),
    lnk("§12 Oftalmológico",        "/es/protocolos-clinicos/adulto/oftalmologico"),
    lnk("§13 ORL",                  "/es/protocolos-clinicos/adulto/orl"),
    lnk("§14 Gastroenterológico",   "/es/protocolos-clinicos/adulto/gastroenterologico"),
    lnk("§15 Gineco-Obstétrico",    "/es/protocolos-clinicos/adulto/gineco-obstetrico"),
    lnk("§16 Infectológico",        "/es/protocolos-clinicos/adulto/infectologico"),
    lnk("§17 Nefrológico",          "/es/protocolos-clinicos/adulto/nefrologico"),
    lnk("§18 Metabólico",           "/es/protocolos-clinicos/adulto/metabolico"),
    lnk("§19 Endocrinológico",      "/es/protocolos-clinicos/adulto/endocrinologico"),
    lnk("§20 Inmunoalérgico",       "/es/protocolos-clinicos/adulto/inmunoalergico"),
    lnk("§21 Hemato-Oncológico",    "/es/protocolos-clinicos/adulto/hemato-oncologico"),
    lnk("§22 Psiquiátrico",         "/es/protocolos-clinicos/adulto/psiquiatrico"),
    lnk("§23 Compromiso Sistémico", "/es/protocolos-clinicos/adulto/compromiso-sistemico"),

    # L2 sub-grupo B: Pediátrico / Neonatal — Decreto 34 Título VI, Art. 27
    lnk("Pediátrico / Neonatal — Decreto 34", "/es/protocolos-clinicos/pediatrico", "mdi-chevron-right"),
    lnk("§1 Respiratorio",          "/es/protocolos-clinicos/pediatrico/respiratorio"),
    lnk("§2 Circulatorio",          "/es/protocolos-clinicos/pediatrico/circulatorio"),
    lnk("§3 Neurológico",           "/es/protocolos-clinicos/pediatrico/neurologico"),
    lnk("§4 Trauma",                "/es/protocolos-clinicos/pediatrico/trauma"),
    lnk("§5 Quirúrgico",            "/es/protocolos-clinicos/pediatrico/quirurgico"),
    lnk("§6 Gran Quemado",          "/es/protocolos-clinicos/pediatrico/gran-quemado"),
    lnk("§7 Intoxicación",          "/es/protocolos-clinicos/pediatrico/intoxicacion"),
    lnk("§8 Accidentes",            "/es/protocolos-clinicos/pediatrico/accidentes"),
    lnk("§9 Endocrinológico",       "/es/protocolos-clinicos/pediatrico/endocrinologico"),
    lnk("§10 Inmunoalérgico",       "/es/protocolos-clinicos/pediatrico/inmunoalergico"),
    lnk("§11 Oftalmológico",        "/es/protocolos-clinicos/pediatrico/oftalmologico"),
    lnk("§12 ORL",                  "/es/protocolos-clinicos/pediatrico/orl"),
    lnk("§13 Metabólico",           "/es/protocolos-clinicos/pediatrico/metabolico"),
    lnk("§14 Hemato-Oncológico",    "/es/protocolos-clinicos/pediatrico/hemato-oncologico"),
    lnk("§15 Nefrológico",          "/es/protocolos-clinicos/pediatrico/nefrologico"),
    lnk("§16 Infectológico",        "/es/protocolos-clinicos/pediatrico/infectologico"),
    lnk("§17 Gineco-Obstétrico",    "/es/protocolos-clinicos/pediatrico/gineco-obstetrico"),
    lnk("§18 Gastroenterológico",   "/es/protocolos-clinicos/pediatrico/gastroenterologico"),
    lnk("§19 Maltrato Infantil",    "/es/protocolos-clinicos/pediatrico/maltrato-infantil"),
    lnk("§20 Neonatológico",        "/es/protocolos-clinicos/pediatrico/neonatologico"),
    lnk("§21 Psiquiátrico",         "/es/protocolos-clinicos/pediatrico/psiquiatrico"),
    lnk("§22 Compromiso Sistémico", "/es/protocolos-clinicos/pediatrico/compromiso-sistemico"),
    lnk("§23 Vascular Aguda",       "/es/protocolos-clinicos/pediatrico/vascular"),
